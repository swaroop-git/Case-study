...
describe("GET Request", function () {
 ...
 describe("POST Request.", function(){
    describe("Adding a merchant into the merchants collection of the DealsandCouponsUsers Database.",function(){
     ...
     res.body.should.have.property('name').eq("talif bhai..");
     ...
     res.body.should.have.property('price').eq(123456789);
      ...
      afterEach(async () => {
     	await userModel.deleteOne({name: "talif bhai.."})
 	    });
    });
});
 ...
 describe("PUT Request.", function(){
     ...
     res.body.should.have.property('available').eq(false);
     res.body.should.have.property('price').eq(500);
      });
