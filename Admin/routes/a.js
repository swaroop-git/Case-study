...
router.post('/merchant',(req,res)=>{
    axios.post(merchant+'/merchant',req.body).then((response)=>{
        res.send(response.data);
    });
...
router.post('/users',(req,res)=>{
    axios.post(user+'/user',req.body).then((response)=>{
        res.send(response.data);
    });
...
router.put('/merchant/:id',(req,res)=>{
    axios.put(merchant+'/merchant/'+ req.params.id,req.body).then((response)=>{
        res.send(response.data);
    });
...
router.put('/user/:id',(req,res)=>{
    axios.put(user+'/user/'+ req.params.id,req.body).then((response)=>{
        res.send(response.data);
    });
    // res.send(req.params.id);
...
router.delete('/merchant/:id',(req,res)=>{
    axios.delete(merchant+'/merchant/'+ req.params.id,req.body).then((response)=>{
        res.send(response.data);
    });
    // res.send(req.params.id);
...
router.delete('/user/:id',(req,res)=>{
    axios.delete(user+'/user/'+ req.params.id,req.body).then((response)=>{
        res.send(response.data);
    });
    // res.send(req.params.id);
